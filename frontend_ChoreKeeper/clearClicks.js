function attachClickLinks() {
    ...
    document.querySelectorAll("#deleteChore").forEach(name => name.addEventListener('click', removeChore))
    document.querySelectorAll("#edit").forEach(name => name.addEventListener('click', editName))
    document.querySelectorAll("#editChore").forEach(name => name.addEventListener('click', editChore))
    document.querySelectorAll("#addChore").forEach(name => name.addEventListener('click', displayChoreForm))
